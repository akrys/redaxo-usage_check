...
$showAllLinktext = RedaxoCall::i18nMsg('akrys_usagecheck_template_link_show_unused');
if (!$showAll) {
	$showAllParam = '&showall=true';
	$showAllParamCurr = '';
	$showAllLinktext = RedaxoCall::i18nMsg('akrys_usagecheck_template_link_show_all');
}

$showInactiveParam = '';
$showInactiveParamCurr = '&showinactive=true';
$showInactiveLinktext = RedaxoCall::i18nMsg('akrys_usagecheck_template_link_show_active');
if (!$showInactive) {
	$showInactiveParam = '&showinactive=true';
	$showInactiveParamCurr = '';
	$showInactiveLinktext = RedaxoCall::i18nMsg('akrys_usagecheck_template_link_show_active_inactive');
}
?>
								...
								switch (RedaxoCall::getRedaxoVersion()) {
									case RedaxoCall::REDAXO_VERSION_4:
										if ($REX['USER']->isAdmin()) {
											...
											<li><a href="index.php?page=template&subpage=&function=edit&template_id=<?php echo $item['id']; ?>"><?php echo RedaxoCall::i18nMsg('akrys_usagecheck_template_linktext_edit_code'); ?></a></li>
									...
									case RedaxoCall::REDAXO_VERSION_5:
										...
										if ($user->isAdmin()) {
											...
											<li><a href="index.php?page=template&function=edit&template_id=<?php echo $item['id']; ?>"><?php echo RedaxoCall::i18nMsg('akrys_usagecheck_template_linktext_edit_code'); ?></a></li>
